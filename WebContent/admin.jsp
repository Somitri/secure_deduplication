...
<body>
      ...
      <div style="position:absolute; left:36px;  top:80px;"> 
        <div align="left"><font color="#FFFFFF" size="4"><storng><b> 
           A Secure Deduplication of Textual Data in Cloud Environments</b></strong></font> </div>
            ...
            <div id="menu">
				<ul>
                                    <li class="current"><a href="admin.jsp"><b>View Users Requests</b></a></li>
                                    <li><a href="acceptAdmin.jsp"><b>Accepted Users</b></a></li>				
  ...
  <div class="box"> <br>
    ...
    ResultSet rs=st.executeQuery(" select * from user where accept='Waiting'");
    while(rs.next())
               {
        x1=rs.getString(1);
        x2=rs.getString(2);
    ...
    <tr><td><%=x1%></td><td><%=x2%></td><td><%=x4%></td><td><%=x5%></td><td><a href="acceptAdmin1.jsp?<%=x2%>" style="color: red"><%=x7%></a></td></tr>
    <%
       }
    %>
      </table>
