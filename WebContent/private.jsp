...
<body>
  ...
  <div class="box"> <br>
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong><font color="#990000" size="+2" face="Times New Roman" 
	  style="text-decoration:underline">Private Cloud Login</font></strong> <br/>
      <br>
    <form name="s" action="pcloud1.jsp" method="get" onsubmit="return valid()">
      <table align="right" width="400" height="200" background="images/02.jpg">
        <tr> 
          <td><font face="Times New Roman"  size="+1"><strong><img src="images/Users.png" width="30" height="30">&nbsp;&nbsp;Private Cloud 
            Name</strong></font></td>
