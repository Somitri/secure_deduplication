...
<body>
        ...
        <div align="left"><font color="#FFFFFF" size="5"><storng><b> 
           A Secure Deduplication of Textual Data in Cloud Environments</b></strong></font> </div>
            ...
            <div id="menu">
				<ul>
				<li class="current">
					<li><a href="private2.jsp"><b>Home</b></a></li>
  ...
  <div class="box"> <br>
    ...
    <br>
    <br>
    <h3 style="color: green">File Token Successfully Inserted</h3>
    <div class="box1"> 
      <div id="menu"> 
        <div style="position:absolute; left:36px;  top:50px;"> 
          <ul>
            <li><a href="token_view11.jsp"><font color="#CC3300" size="+2"><b>Token Request 
     </b></font></a></li>
    ...
    <div style="position:absolute; left:506px;  top:10px;"> <img src="images/ad.jpg" width="300" height="420"> 
    </div>
