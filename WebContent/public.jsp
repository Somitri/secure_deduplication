...
<body>
    ...
    <div id="logo"> 
      ...
      <div style="position:absolute; left:36px;  top:80px;"> 
        <div align="left"><font color="#FFFFFF" size="3"><storng><b> 
  ...
  <div class="box"> <br>
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong><font color="#990000" size="+2" face="Times New Roman" 
	  style="text-decoration:underline">Public Cloud Login</font></strong> <br/>
      <br>
    <form name="s" action="publiccloud.jsp" method="get" onsubmit="return valid()">
      <table align="right" width="400" height="200" background="images/02.jpg">
        <tr> 
          <td><font face="Times New Roman"  size="+1"><strong><img src="images/Users.png" width="30" height="30">&nbsp;&nbsp;Public Cloud Name
            </strong></font></td>
