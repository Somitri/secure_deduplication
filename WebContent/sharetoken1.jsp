...
<div class="box"> <br>
  ...
  <div style="position:absolute; left:36px;  top:10px;"> 
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong><em><font color="#990000" size="+3" face="Times New Roman"  
	  style="text-decoration:underline">Duplicate File Download</font></em></strong> <br/>
      <br><br>
    <form name="s" action="sharetoken2.jsp" method="post" onSubmit="return valid()">
      <table align="center" width="380">
        
          
          <tr><td style="color: blue">Enter Your Key:</td><td><input type="text" name="pwd" required></td></tr>
          <tr><td></td></tr>
