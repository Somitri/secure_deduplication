...
<div class="box"> <br>
  ...
  <div style="position:absolute; left:36px;  top:10px;"> 
    ...
    <form name="s" action="#" method="get" onSubmit="return valid()">
      <table align="center" bgcolor="#FFFFFF" cellpadding="5" cellspacing="2" width="800" border="1">
        <tr> 
...
PreparedStatement ps=con.prepareStatement("select  * from filetag where status='"+b+"'");
...
while(rs.next())
 ...
 %>
        <tr> 
          ...
          <td bgcolor="#CCFFFF"><a href="tokengen.jsp?  <%=fid%> <%=reqid%> <%=userid%>  <%=tag%>" style="color: blue">Send Token</a></td>
        </tr>
        <%
}
%>
