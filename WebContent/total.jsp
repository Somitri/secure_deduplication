...
<div class="box"> <br>
  ...
  <div style="position:absolute; left:36px;  top:10px;"> 
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	  ...
	  style="text-decoration:underline">User Data Details</font></em></strong> <br/>
      <br>
    <form name="s" action="#" method="get" onSubmit="return valid()">
      <table  bgcolor="#FFFFFF" cellpadding="5" cellspacing="2" width="725" border="1">
        <tr> 
            <td bgcolor="#CCCCCC"><font face="Times New Roman" size="+1" color="blue"><strong>File Id
           </strong></font></td>
          <!--  <td bgcolor="#CCCCCC"><font face="Times New Roman" size="+1"><strong>Request Id
           </strong></font></td>-->
        <td bgcolor="#CCCCCC"><font face="Times New Roman" size="+1" color="blue"><strong>Status
           </strong></font></td>
         
           
        <td bgcolor="#CCCCCC"><font face="Times New Roman" size="+1" color="blue"><strong>Action
...
%>
        ...
        <tr> 
          ...
          <td bgcolor="#CCFFFF"><a href="upload.jsp?  <%=userid%> <%=fid%> <%=status%>" style="color: red">Upload File</a></td>
        </tr>
        <%
          ...
          <td bgcolor="#CCFFFF"><a href="download.jsp?  <%=s%> <%=fid%> <%=status%>">Request for Download </a></td>
        </tr>
